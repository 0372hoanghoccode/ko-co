...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void execute() {
        setForeground(Color.decode("#3498db"));
    ...
    private void initComponents() {
        ...
        header.setBackground(Color.decode("#3498db"));
      
        header.setMaximumSize(new java.awt.Dimension(262, 40));

        cmdForward.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        // cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/appIcon/icons8-next-50.png"))); // NOI18N
        cmdForward.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/assets/appIcon/icons8-next-50.png")).getImage().getScaledInstance(18, 18, Image.SCALE_SMOOTH)));
        ...
        cmdMonth.setFont(new java.awt.Font("Kh Content", 0, 15)); // NOI18N
        ...
        lb.setFont(new Font("Arial",0,16));
        ...
        cmdYear.setFont(new java.awt.Font("Kh Content", 0, 15)); // NOI18N
        ...
        // cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/appIcon/icons8-back-50.png"))); // NOI18N
        cmdPrevious.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/assets/appIcon/icons8-back-50.png")).getImage().getScaledInstance(18, 18, Image.SCALE_SMOOTH)));
