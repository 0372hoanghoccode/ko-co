...
public class LUONG {
    ...
    public LUONG(String maLuong, String maChamCong, double luongThucTe, double luongThuong, double phuCapChucVu,double phuCapKhac,double khoanTruBaoHiem,double khoanTruKhac, double thue, double thucLanh) {
        this.maLuong = maLuong;
        this.luongThucTe = luongThucTe;
        this.maBangChamCong = maChamCong;
